...
namespace AntsColonies.RedAnts
{
    class AdvancedWarrior : BaseWarrior
    {
        ...
        {
            protected new readonly AdvancedWarrior Owner;
            public OnAnthillState(AdvancedWarrior owner)
        ...
        {
            protected new readonly AdvancedWarrior Owner;
            public OnHeapState(AdvancedWarrior owner, Heap heap)
        ...
        public AdvancedWarrior(BaseAntQueen queen)
        : base("<[Advanced] red warrior>", 6, 2, 3, queen)
