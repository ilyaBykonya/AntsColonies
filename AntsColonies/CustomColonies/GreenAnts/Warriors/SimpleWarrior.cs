...
namespace AntsColonies.GreenAnts
{
    class SimpleWarrior : BaseWarrior
    {
        ...
        {
            protected new readonly SimpleWarrior Owner;
            public OnAnthillState(SimpleWarrior owner)
        ...
        {
            protected new readonly SimpleWarrior Owner;
            public OnHeapState(SimpleWarrior owner, Heap heap)
        ...
        public SimpleWarrior(BaseAntQueen queen)
        : base("<[Simple] green warrior>", 1, 0, 1, queen)
