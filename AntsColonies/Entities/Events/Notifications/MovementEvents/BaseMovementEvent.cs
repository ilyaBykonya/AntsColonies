...
namespace AntsColonies.Base.Events.Notifications.MovementEvents
{
    class BaseMovementEvent : BaseNotification
    {
        public BaseHikingUnit Unit { get; }
        public BaseMovementEvent(BaseHikingUnit unit) => Unit = unit;
    }
}
